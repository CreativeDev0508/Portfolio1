export const projectData = [
  {
    ...
    technologies: ['Wordpress', 'JavaScript (ES6+)'],
    imageUrl: '/rasters/project/project1.png',
    mobileUrl: '/rasters/project/project1.png',
    repository: 'https://github.com/CreativeDev0508',
    livelink: 'https://tokuzo-welfare.com/',
  },
  {
    id: crypto.randomUUID(),
    title: 'ALUMO(アルモ)｜大学1・2年生向けインターンプラットフォーム',
    description:
    ...
    imageUrl: 'rasters/project/project2.png',
    mobileUrl: 'rasters/project/project2.png',
    repository: 'https://github.com/CreativeDev0508',
    livelink: 'https://alumo.career/student',
  },
  {
    id: crypto.randomUUID(),
    title: '動画共有サイト',
  ...
  },
  {
    ...
    technologies: ['React', 'IndexDB', 'PHP', 'mySQL', 'Laravel'],
    imageUrl: 'rasters/project/project3.png',
    mobileUrl: 'rasters/project/project3.png',
    repository: 'https://github.com/CreativeDev0508',
    // livelink: '',
  },
  {
